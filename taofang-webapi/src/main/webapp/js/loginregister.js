...
function refreshVCode() {
    $.ajax({
        url: "http://localhost:8080/taofang/webapi/user/vcode",
...
function login() {
    ...
    if(errorMessage == ""){
        ...
        $.ajax({
            timeout: 5000,
            url: "http://localhost:8080/taofang/webapi/user/login",
...
function register() {
    ...
    if(errorMessage == ""){
        ...
        $.ajax({
            timeout: 5000,
            url: "http://localhost:8080/taofang/webapi/user/register",
            contentType: "application/json",
